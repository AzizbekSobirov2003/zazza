...
export default function TabsItem1() {
  ...
  return (
    <Box sx={{ width: "90%", margin: "0 auto", marginTop: "50px" , backgroundColor: 'white' ,height:'254px' }}>
      ...
      <CustomTabPanel  value={value} index={0} >
        <br />
        <span className="text-[18px] font-[500] relative left-[720px] bottom-[200px]">Описание оборудования</span>
        <br />
        <span className=" relative left-[720px] bottom-[200px]">Вес оборудования . . . . . . . . . . . 90 кг</span>
        <br />
        <span className=" relative left-[720px] bottom-[200px]">
          Детектор . . . . . . . . . . . . . . . . . CsI - на основе аморфного
          кремния
        </span>
        <br />
        <span className=" relative left-[720px] bottom-[200px]">Время сканирования . . . . . . . . . PAN стандарт - 12 сек</span>
      </CustomTabPanel>
